...
| 172 | One realistic query. *First candidate from task 193: TPC-DS `modified-q3`, whose filter of about fifty `ss_sold_date_sk` ranges over a scan compiles to a 12167-byte `processNext`* | 2.6 | small to medium |
